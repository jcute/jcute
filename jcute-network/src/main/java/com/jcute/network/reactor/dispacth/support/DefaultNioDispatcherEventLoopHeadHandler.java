...
public class DefaultNioDispatcherEventLoopHeadHandler extends DefaultNioDispatcherEventLoopContext implements NioDispatcherEventLoopHandler{

	private static final String NAME = "__HEAD__";

	public DefaultNioDispatcherEventLoopHeadHandler(NioDispatcherEventLoopChain chain){
