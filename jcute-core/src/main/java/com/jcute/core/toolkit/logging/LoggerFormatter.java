...
public class LoggerFormatter{
	...
	public static LoggerTuple format(String messagePattern,Object arg){
		return arrayFormat(messagePattern,new Object[]{arg});
	}

	public static LoggerTuple format(final String messagePattern,Object argA,Object argB){
		return arrayFormat(messagePattern,new Object[]{argA,argB});
	}
	
	public static LoggerTuple arrayFormat(final String messagePattern,final Object[] argArray){
		if(argArray == null || argArray.length == 0){
			return new LoggerTuple(messagePattern,null);
		}
		...
		if(messagePattern == null){
			return new LoggerTuple(null,throwable);
		}

		int j = messagePattern.indexOf(DELIM_STR);
		if(j == -1){
			return new LoggerTuple(messagePattern,throwable);
		}
		...
		return new LoggerTuple(sbuf.toString(),L <= lastArrIdx ? throwable : null);
	}
